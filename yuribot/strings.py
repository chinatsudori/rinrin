...
_STRINGS.update(
    {
        ...
        "fun.akinator.question_title": "{mode} — Question {n}",
        "fun.akinator.footer": "Still considering {count} characters.",
        "fun.akinator.candidates_title": "Short list",
        "fun.akinator.candidates": "Top picks: {names}",
        "fun.akinator.waiting_guess": "I'm thinking…",
        "fun.akinator.guess_title": "{mode} thinks it knows!",
        "fun.akinator.guess_text": "I'm about {pct}% sure it's **{name}** from *{series}*.",
        "fun.akinator.reason_title": "Why I'm guessing",
        "fun.akinator.no_guess": "I couldn't form a confident guess, but here's what I narrowed down.",
        "fun.akinator.cancelled": "{mode} session closed. Thanks for playing!",
        "fun.akinator.timeout": "{mode} timed out. Run /rinrinator to start a fresh round.",
        "fun.akinator.not_owner": "Only {user} can answer for this round.",
        "fun.akinator.session_closed": "This session already ended — run /rinrinator to start again.",
        "fun.akinator.button.guess": "Show Guess",
        "fun.akinator.button.end": "End Game",
        # ---------------- Music ----------------
        "music.track.unknown": "Unknown track",
        "music.controller.not_connected": "Player is not connected.",
        "music.controller.join_voice": "Join my voice channel to use the controller!",
        "music.error.other_client": "Another voice client is already running here.",
        "music.error.join_voice_first": "Join a voice channel first!",
        "music.controller.now_playing": "Now Playing",
        "music.controller.now_playing_desc": "{track}\nRequested by {requester}",
        "music.controller.field_duration": "Duration",
        "music.controller.idle": "Player Idle",
        "music.controller.idle_hint": "Add something to the queue with /play",
        "music.controller.field_loop": "Loop",
        "music.controller.loop_on": "On",
        "music.controller.loop_off": "Off",
        "music.controller.field_volume": "Volume",
        "music.controller.volume_value": "{percent}%",
        "music.controller.field_up_next": "Up Next",
        "music.controller.up_next_line": "{idx}. {track} — {requester}",
        "music.queue.line_now": "Now: {track}",
        "music.queue.line_entry": "{idx}. {track} — {duration}",
        "music.queue.embed_title": "Queue",
        "music.cmd.play": "Play a song or playlist from YouTube",
        "music.cmd.pause": "Pause the current track",
        "music.cmd.resume": "Resume playback",
        "music.cmd.skip": "Skip the current track",
        "music.cmd.stop": "Stop playback and clear the queue",
        "music.cmd.leave": "Disconnect the bot from voice",
        "music.cmd.nowplaying": "Show the current track",
        "music.cmd.queue": "Show the queue",
        "music.cmd.volume": "Set the player volume (1-150)",
        "music.cmd.controller": "Post or refresh the music controller",
        "music.cmd.playlist": "Manage server playlists",
        "music.cmd.playlist_save": "Save the current queue as a playlist",
        "music.cmd.playlist_load": "Load a saved playlist into the queue",
        "music.cmd.playlist_delete": "Delete a saved playlist",
        "music.error.no_matches": "No matches found.",
        "music.info.queued_single": "Queued {title}",
        "music.info.queued_multi": "Queued {count} tracks",
        "music.error.nothing_playing": "Nothing is playing.",
        "music.info.paused": "Paused ⏸️",
        "music.info.resumed": "Resumed ▶️",
        "music.error.nothing_to_skip": "Nothing to skip.",
        "music.info.skipped": "Skipped ⏭️",
        "music.error.not_connected": "I'm not connected.",
        "music.info.stopped": "Stopped and cleared the queue.",
        "music.error.not_in_voice": "I'm not in a voice channel.",
        "music.info.disconnected": "Disconnected.",
        "music.error.queue_empty": "Queue is empty.",
        "music.info.volume_set": "Volume set to {level}%",
        "music.error.nothing_to_control": "Nothing to control yet.",
        "music.info.controller_refreshed": "Controller refreshed.",
        "music.info.playlists_none": "No playlists saved yet.",
        "music.info.playlists_list": "Playlists: {names}",
        "music.error.nothing_to_save": "Nothing to save.",
        "music.error.no_urls_to_save": "Unable to save tracks without URLs.",
        "music.info.playlist_saved": "Saved playlist **{name}** with {count} tracks.",
        "music.error.playlist_missing": "Playlist not found.",
        "music.error.resolve_failed": "Unable to resolve any tracks from that playlist.",
        "music.info.playlist_loaded": "Loaded playlist **{name}** ({count} tracks).",
        "music.info.playlist_deleted": "Deleted playlist **{name}**.",
        # ---------------- MoveAny / ThreadTools ----------------
